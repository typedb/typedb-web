...
const logo = (params: GenerateParams) => {
    ...
    const logoImage = `<svg width="124" height="42" viewBox="0 0 2025 687" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M800 486.998V277.003H879.006V237H677V277.003H756V486.998H800Z" fill="currentColor"/>
  <path fill-rule="evenodd" clip-rule="evenodd" d="M990.5 559L1073.7 303.391L1076 297.004H1033L985.01 450.001L980 450L932 297H889L891.117 303.391L950.847 487H972.702L947.122 559H990.5Z" fill="currentColor"/>
...
const secondaryArea = (params: GenerateParams) => {
    ...
    const button = linkHtml({
        content: `<span>${escapeHtml(topnav.cta.text)}</span>`,

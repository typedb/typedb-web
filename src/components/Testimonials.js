...
const testimonials = [
  ...
  {name: 'Samuel Pouyt', company: 'Software Architect, European Respiratory Society', img: '/assets/img/testimonials/samuel.jpg', review: '“Whether it is for content recommendation, managing GDPR or text classification, the more I use GRAKN.AI, the more I discover suitable use cases. Its power and simplicity makes it an everyday tool”'},
];

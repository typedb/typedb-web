        ...
        <section className="about__team">
          <div className="container section__container">
              ...
              <div className="about__team__text">
                <span className="about__team__text__col1">Grakn enables the world to organise complex networks of data that serves as the knowledge foundation of intelligent systems. Grakn provides the knowledge engineering tools to turn rich datasets into a body of knowledge. Five years from now, Grakn will be de facto data platform for intelligent systems. We're a team with big ambitions, and our competitions are fierce. However, no database company tackles the problem of data complexity as we do.</span>

const getData = async () => {
  let { speakers, sessions, categories } = await $.get(
    "https://sessionize.com/api/v2/mv3kpmg0/view/all"
  );
  ...
  const tags = [
    ...
    },
    {
      ...
      color: "blue-b",
      description:
        "Stories of the development of TypeDB itself, its infrastructure and research"
    },
    {
      name: "#iot",
      color: "orange-a",

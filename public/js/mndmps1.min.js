...
window.MNDMPS.App={_data:{},typist:function(){$("#typist").typed({strings:["a knowledge graph","a reasoning engine","a network analysis tool","a distributed semantic database"],typeSpeed:5,backSpeed:5,backDelay:2E3,loop:false})},initPrism:function(){var textareas=document.getElementsByClassName("code-input");function renderOutput(input){var value=input.value;value=value.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")+"\n";$(input).next().children(0)[0].innerHTML=value;Prism.highlightAll()}

...
window.MNDMPS.Nav={_data:{},toggleWhite:function(state){var data=this._data,action=state?"add":"remove";data.nav.classList[action]("white")},checkPosition:function(){var _this=window.MNDMPS.Nav,data=_this._data,windowHeight=window.innerHeight,scrolled=document.body.scrollTop;if(scrolled>windowHeight/8)_this.toggleWhite(true);else _this.toggleWhite(false)},checkWidth:function(){var _this=window.MNDMPS.Nav,data=_this._data;if(window.innerWidth>=750)data.menu.classList.remove("active")},toggleMenu:function(event){var _this=

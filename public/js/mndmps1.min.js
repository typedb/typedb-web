...
event.cancelBubble=true;event.returnValue=false;return false}};window.MNDMPS=window.MNDMPS||{};
...
if(codeEditor)window.addEventListener("resize",function(){var tabs=codeEditor.getElementsByClassName("content")[0].children;for(var i=0;i<tabs.length;i++)if(tabs[i].classList.contains("active")){window.MNDMPS.Graph.redraw("graph"+i);break}},false);window.MNDMPS.Slider.init();google.maps.event.addDomListener(window,"load",window.MNDMPS.Map.load)}};window.MNDMPS.App.init();

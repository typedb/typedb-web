...
data class HelmValues(
    ...
    val gcpSecretStrapiTransferTokenSaltVersion: String,
    val gcpSecretStrapiAdminJwtSecretVersion: String,
    val gcpSecretStrapiJwtSecretVersion: String,
    val gcpSecretStrapiBackupEncryptionKeyVersion: String,
    val gkeName: String,
    ...
    fun asMap(): Map<String, String> = mapOf(
        ...
        "infrastructure.gcp.secret_manager.strapi_transfer_token_salt.version" to gcpSecretStrapiTransferTokenSaltVersion,
        ...
        "infrastructure.gcp.secret_manager.strapi_backup_encryption_key.version" to gcpSecretStrapiBackupEncryptionKeyVersion,

...
data class HelmValues(
    ...
    val gcpSecretStrapiAdminJwtTokenVersion: String,
    val gcpSecretStrapiJwtTokenVersion: String,
    val gkeName: String,
    ...
    fun asMap(): Map<String, String> = mapOf(
        ...
        "infrastructure.gcp.secret_manager.strapi_admin_jwt_token.version" to gcpSecretStrapiAdminJwtTokenVersion,
        "infrastructure.gcp.secret_manager.strapi_jwt_token.version" to gcpSecretStrapiJwtTokenVersion,

...
export const componentSchemas = [...conclusionPanelSchemas, ...contextTextPanelSchemas, ...featureGridSchemas, furtherReadingSectionSchema, ...featureTableSchemas, ...linkPanelSchemas];

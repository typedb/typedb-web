...
import {
    ...
    referenceMaterialSchemaName,
    genericPageSchemaName,
    personSchemaName,
    lectureSchemaName,
    ...
    liveEventSchemaName,
    eventsPageSchemaName,
    supportPageSchemaName,
    servicesPageSchemaName,
    testimonialSchemaName,
    ...
    fundamentalsPageSchemaName,
    cloudUiBannerSchemaName,
    surveySchemaName,
    cloudProviderSchemaName,
    countrySchemaName,
    continentSchemaName,
    cloudOnboardingSchemaName,
    cloudLoginPortalSchemaName,
    pricingPageSchemaName,
    startupProgramPageSchemaName,
    cloudAnnouncementSchemaName
        ...
        deskTool({
            structure: (s: StructureBuilder) => s.list().title("Content").items([
                ...
                s.listItem().title("Pages - Main Site").icon(DocumentsIcon).child(s.list().title("Pages - Main Site").items([
                    ...
                    s.divider(),
                    singletonListItem(s, pricingPageSchemaName, { title: "Pricing", icon: DocumentIcon }),

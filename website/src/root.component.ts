...
//
//     constructor(
//         // canonicalLink: CanonicalLinkService, changeDet: ChangeDetectorRef, contentService: ContentService,
//         // router: Router, location: LocationStrategy, activatedRoute: ActivatedRoute, viewportScroller: ViewportScroller,
//         // _dialogService: DialogService, _cookieConsentService: NgcCookieConsentService, domSanitizer: DomSanitizer,
//         // matIconRegistry: MatIconRegistry, analyticsService: AnalyticsService, _formService: FormService,
//     ) {

    ...
    return (
        <VaticleLayout>
            <section className={classes.firstSectionMargin}>
                ...
                <FeatureWithSnippet id="availability" className={classes.subsectionMargin} examplePosition="left"
                    ...
                    <ConsoleSnippet code={highAvailabilityExample}/>
                </FeatureWithSnippet>
                <FeatureWithSnippet id="scalability" className={classes.subsectionMargin} examplePosition="right"
                              ...
                              load-balancing transparently for applications."
                                    button={{text: "Documentation", href: urls.docs.home}}>
                    <ConsoleSnippet code={elasticThroughputExample}/>
                </FeatureWithSnippet>
                <FeatureWithSnippet id="authentication" className={classes.subsectionMargin} examplePosition="left"
                              ...
                              write access on a given database schema or data."
                                    button={{text: "Documentation", href: urls.docs.home}}>
                    <ConsoleSnippet code={secureAuthenticationExample}/>
                </FeatureWithSnippet>
                <FeatureWithSnippet id="encryption" className={classes.subsectionMargin} examplePosition="right"
                              ...
                              transmitted to and from the the database server."
                                    button={{text: "Documentation", href: urls.docs.home}}>
                    <ConsoleSnippet code={inFlightEncryptionExample}/>
                </FeatureWithSnippet>
                <FeatureWithSnippet id="management" className={classes.subsectionMargin} examplePosition="left"
                    ...
                    <ConsoleSnippet code={clusterManagementExample}/>
                </FeatureWithSnippet>
                <FeatureWithSnippet id="backup" className={classes.subsectionMargin} examplePosition="right"
                                    title="Live Backup"
                              ...
                              and restore operations can be performed via simple commands in the CLI."
                                    button={{text: "Coming Soon!", disabled: true, comingSoon: true}}>
                    <ConsoleSnippet code={liveBackupExample}/>
                </FeatureWithSnippet>
            </section>

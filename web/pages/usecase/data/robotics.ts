...
export const roboticsData: UseCaseData = {
    ...
    "section3": {
        "title": "Increase Autonomy in Your Robotic Systems",
        "keyPoints": [
            {
                "title": "Improved Task Planning Efficiency",
                "body": "TypeDB enables you to build knowledge bases that describe the structure to understand and conceptualise the task planning of your robot in a real-world setting. Using TypeDB's inference engine, your robot will be able make decisions independently for more efficient autonomous task planning.",
                "icon": InferenceIcon
            },
            {
    ...
    "section4": {
        "title": "Build Robotic Systems on the Shoulders of TypeDB",
        "keyPoints": [
            {
                "title": "Autonomous Drones",
                "body": "For autonomous drones to move on their own, they require to perform tasks autonomously such as environment modelling, place localisation and task planning. TypeDB becomes the unifying knowledge base that ties these systems together, enabling the drone to make decisions on its own without needing human intervention."
            },
            {

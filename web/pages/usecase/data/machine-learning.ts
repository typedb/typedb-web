...
export const machineLearningData: UseCaseData = {
    ...
    "section4": {
        ...
        "body": [
            "Whatever it is you're building, using TypeDB to build a knowledge graph for machine learning will give you the right context, semantics and inference capabilities to enable your learner to really understand and capitalise upon connected data. TypeDB allows you to use any of the wide range of graph learning approaches for link prediction, node classification or attribute prediction, and combine them with TypeDB's inference engine. Through our open source repository KGLIB, TypeDB provides direct integrations with TensorFlow and PyTorch Geometric that you can start using today.",

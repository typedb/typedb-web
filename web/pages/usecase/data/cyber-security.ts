...
export const cyberSecurityData: UseCaseData = {
    ...
    "section4": {
        ...
        "body": [
            ...
            "To help you get started with TypeDB, together with the community we have released an open source CTI platform called [TypeDB CTI](https://github.com/typedb-osi/typedb-cti) that you can start using today. Based on the well-known [STIX](https://oasis-open.github.io/cti-documentation/stix/intro.html) data standard, it provides a unified approach to the description of different kinds of cybersecurity data. This makes it straightforward for cyber security analysts to ingest heterogeneous threat intelligence data through a single common language which describes the data they work with.",

...
export const cyberSecurityData: UseCaseData = {
        ...
        "keyPoints": [
            {
                ...
                "body": "TypeDB guarantees that every piece of data has a predefined type. Based on object-oriented principles, this makes modelling context and semantics in cybersecurity data straightforward.",
                "icon": ContextualiseIcon
            },
            {
                "title": "Type Safety Guarantees",
                "body": "TypeDB gives you concrete assurances that all of your data is both typed (within a rich type hierarchy) and logically consistent; a great platform on which to turn different kinds of cybersecurity data into knowledge.",
                "icon": SecurityIcon
            },
            {
    ...
    "section4": {
        ...
        "keyPoints": [
            {
                "title": "Security Event and Incident Management",
                "body": "SIEM tools are an essential part of the data security ecosystem. They require aggregating data from multiple systems and analyse it to find malicious behaviour of possible cyberattacks. Through its strong type system, TypeDB makes it possible to represent the complexity inherent in such data and make actionable use of it."
            },
            {
            ...
            },
            {
                ...
                "body": "In order to detect, investigate and quickly respond to suspicious activities on hosts and endpoints, we require to aggregate activity from various endpoints. Given the complex nature of such data, TypeDB enables you to accurately represent this in one unified representation, in order to make sense of all the incoming information and find the right insights."
            }
        ],
        "body": [
            "Given the heterogeneous and complex nature of cybersecurity data across any use case, it is a perfect fit for TypeDB. TypeDB's expressive schema language, which allows for concepts such as type hierarchies and hyper relations, gives you a level of expressivity which can model the most complex cybersecurity data as accurately as possible. And through that semantic richness, TypeDB makes it easy to discover new insights, improving prevention of cyberattacks and helping to secure your enterprise.",
            "To help the cyber threat intelligence (CTI) community, we have built an open source CTI platform called [TypeDB CTI](https://github.com/typedb-osi/typedb-data-cti). Based on the [STIX](https://oasis-open.github.io/cti-documentation/stix/intro.html) standard, it provides a unified approach to the description of different kinds of cybersecurity data. This makes it straightforward for cyber security analysts to ingest heterogeneous CTI data through a single common language which describes the data they work with.",

...
const latestReleaseDate = new Date("2022-05-25 17:00:00");
const latestReleaseDateFormatted = moment(latestReleaseDate).format("Do [of] MMMM YYYY");
const studioVersion = "2.10.0-alpha";
const latestReleaseNotesURL = `${urls.github.typedbStudioReleases}/tag/${studioVersion}`;
const downloads: Downloads = {
    "Ubuntu / Debian": {
        "2.10.0-alpha": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha/typedb-studio_2.10.0-alpha-1_amd64.deb",
    ...
    "Linux (cross-platform)": {
        "2.10.0-alpha": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha/typedb-studio-linux-java-binary-2.10.0-alpha.tar.gz",
    },
    "macOS": {
        "2.10.0-alpha": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha/typedb-studio-mac-2.10.0-alpha.dmg",
    ...
    "Windows": {
        "2.10.0-alpha": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha/typedb-studio-windows-2.10.0-alpha.exe",
...
const defaultVersion: string = "2.10.0-alpha";
        ...
        <>
            ...
            <div
                ...
                <VaticleSelect label="Version" value={selectedVersion} setValue={setSelectedVersion} inputName="version"
                    ...
                    <option value="2.10.0-alpha">2.10.0-alpha</option>

...
const studioVersion = "2.10.0-alpha-6";
const latestReleaseNotesURL = `${urls.github.typedbStudioReleases}/tag/${studioVersion}`;
const downloads: Downloads = {
    "Ubuntu / Debian": {
        "2.10.0-alpha-6": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha-6/typedb-studio_2.10.0-alpha-6-1_amd64.deb",
    ...
    "Linux (cross-platform)": {
        "2.10.0-alpha-6": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha-6/typedb-studio-linux-java-binary-2.10.0-alpha-6.tar.gz",
    },
    "macOS": {
        "2.10.0-alpha-6": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha-6/typedb-studio-mac-2.10.0-alpha-6.dmg",
    ...
    "Windows": {
        "2.10.0-alpha-6": "https://github.com/vaticle/typedb-studio/releases/download/2.10.0-alpha-6/typedb-studio-windows-2.10.0-alpha-6.exe",
...
const defaultVersion: string = "2.10.0-alpha-6";
        ...
        <>
            ...
            <div
                ...
                <VaticleSelect label="Version" value={selectedVersion} setValue={setSelectedVersion} inputName="version"
                    ...
                    <option value="2.10.0-alpha-6">2.10.0-alpha-6</option>

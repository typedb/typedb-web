...
type TypeDBVersion = "2.12.0" | "2.11.1" | "2.11.0" | "2.10.0" | "2.8.1" | "2.8.0" | "2.7.1" | "2.7.0" | "2.6.4" | "2.6.3" | "2.6.2"
    | "2.6.1" | "2.6.0" | "2.5.0" | "2.4.0" | "2.3.3" | "2.3.2" | "2.3.1" | "2.3.0" | "2.2.0" | "2.1.3" | "2.1.1" | "2.0.2"
    | "2.0.1" | "2.0.0";
...
const latestReleaseDateFormatted = moment(new Date("2022-06-28")).format("Do [of] MMMM YYYY");
const downloads: Downloads = {
    ...
    "Linux": {
        "2.12.0": "https://github.com/vaticle/typedb/releases/download/2.12.0/typedb-all-linux-2.12.0.tar.gz",
    ...
    "Windows": {
        "2.12.0": "https://github.com/vaticle/typedb/releases/download/2.12.0/typedb-all-windows-2.12.0.zip",

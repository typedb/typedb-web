...
type TypeDBVersion = "2.15.0" | "2.14.2" | "2.14.1" | "2.13.0" | "2.12.0" | "2.11.1" | "2.11.0" | "2.10.0" | "2.8.1" | "2.8.0"
    | "2.7.1" | "2.7.0" | "2.6.4" | "2.6.3" | "2.6.2" | "2.6.1" | "2.6.0" | "2.5.0" | "2.4.0" | "2.3.3" | "2.3.2"
    | "2.3.1" | "2.3.0" | "2.2.0" | "2.1.3" | "2.1.1" | "2.0.2" | "2.0.1" | "2.0.0";
...
const latestReleaseDateFormatted = moment(new Date("2023-02-11")).format("Do [of] MMMM YYYY");

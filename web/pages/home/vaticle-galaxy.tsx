    ...
    return (
        <svg width={480} height={480} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <g fill="none" fillRule="evenodd">
                    ...
                    <g mask="url(#vaticle-atom_svg__b)">
                        <g transform="translate(32 25)">
                            ...
                            <path
                                ...
                                fill="#1D1354"/>
                            <path d="M7.033.175a5.738 5.738 0 012.308 10.993v12.984H4.75V11.18A5.74 5.74 0 017.033.175z"
                                  fill="#02DAC9"/>
                        </g>
                    </g>
                </g>
                ...
                <path d="M240 407c92.508 0 167.5-74.992 167.5-167.5" stroke="#F66B65" strokeWidth={0.6}
                      className={classes.red}/>
                <path d="M237 72c-58.559 0-110.12 29.96-140.19 75.389" stroke="#F66B65" strokeLinecap="round"
                      className={classes.red}/>
                <path
                ...
                <path fill="#02DAC9" d="M467.513 169.82l1.854 5.706-5.706 1.854-1.855-5.706z"

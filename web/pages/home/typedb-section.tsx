...
export const TypeDBSection: React.FC<ClassProps> = ({className}) => {
    ...
    return (
        <section className={className}>
            ...
            <KeyPointWithCodeExample className={classes.subsectionMargin} examplePosition="left" title="Expressivity"
            ...
            <KeyPointWithCodeExample className={classes.subsectionMargin} examplePosition="right" title="Safety"
            ...
            <KeyPointWithCodeExample className={classes.subsectionMargin} examplePosition="left" title="Inference"
            ...
            <KeyPointWithCodeExample className={classes.subsectionMargin} examplePosition="right" title="Programmatic API"

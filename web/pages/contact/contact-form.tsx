...
export const ContactForm: React.FC<ClassProps> = ({className}) => {
    ...
    return (
        <div className={clsx(classes.root, className)}>
            ...
            <VaticleSnackbar variant="success" message="Your message has been sent." open={confirmationSnackbarOpen}
                             setOpen={setConfirmationSnackbarOpen}/>
            <VaticleSnackbar variant="error" message="Your message failed to send, please try again later."
                             open={errorSnackbarOpen} setOpen={setErrorSnackbarOpen}/>
        </div>
    );
}

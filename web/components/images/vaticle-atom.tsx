                ...
                <g transform="translate(180 188)">
                    ...
                    <g mask="url(#vaticle-atom_svg__b)">
                        <g transform="translate(32 25)">
                            ...
                            <path d="M41.636 21.982c8.077 0 14.625 6.548 14.625 14.625 0 8.07-6.543 14.613-14.614 14.613h-.01l-23.464-.018c-8.08-.006-14.638-6.535-14.68-14.615-.04-8.025 6.431-14.563 14.456-14.604h23.687zM20.732 30.47c-3.556 0-6.438 2.786-6.438 6.224 0 3.437 2.882 6.223 6.438 6.223 3.556 0 6.439-2.786 6.439-6.223 0-3.438-2.883-6.224-6.439-6.224zm19.585 0c-3.556 0-6.439 2.786-6.439 6.224 0 3.437 2.883 6.223 6.439 6.223s6.438-2.786 6.438-6.223c0-3.438-2.882-6.224-6.438-6.224z"
                                fill="#1D1354"/>
                            <path d="M7.033.175a5.738 5.738 0 012.308 10.993v12.984H4.75V11.18A5.74 5.74 0 017.033.175z" fill="#02DAC9"/>
                        </g>
                    </g>
                </g>
                <circle stroke="#02DAC9" strokeWidth={0.4} cx={240} cy={240} r={234.8} className={classes.green}/>
                <path d="M10.373 189.805C6.853 205.978 5 222.773 5 240c0 69.305 30 131.602 77.724 174.615M240 475c77.172 0 145.656-37.199 188.5-94.644C457.708 341.191 475 292.615 475 240m-10.804-70.644C434.206 74.088 345.172 5 240 5 171.35 5 109.575 34.437 66.61 81.377"
                    stroke="#02DAC9" strokeWidth={2} className={classes.green}/>
                <circle stroke="#1C4A97" strokeWidth={0.4} cx={240} cy={240} r={219.8}/>
                <circle stroke="#1C4A97" strokeWidth={0.4} cx={240} cy={240} r={214.911}/>
